                ...
                <div class="col-lg-6">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3 mb-4">
                            <div class="line"></div> <small class="or text-center">Registrarse</small>
                            <div class="line"></div>
                        </div>
                        <form action="./app/register.php" method="post">
                            ...
                            <div class="row mb-3 px-3"> <button type="submit"
                                    class="btn btn-blue text-center">Registrarse</button> </div>
                            <div class="row mb-4 px-3"> <small class="font-weight-bold">Ya tienes una cuenta? <a
                                        class="text-danger " href="./index.php">Login</a></small> </div>
                        </form>
                    </div>
                </div>
            </div>
